    ...
    ?>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <?php 
            $sentencia = "select * from vulnerabilities where id=".$id_url;    
          ...
          ?>
                    ...
                    <form class="form-sample" form action="" method="post">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-8">
                              <select class="form-control" id="exampleSelectGender" style="color:white" name="level" required>
                                <option value="<?php echo $level_num ?>"><?php echo lang($level)?></option>
                      ...
                      <div class="row">
                        <div class="form-group row">
                          ...
                          <textarea class="form-control m-3 text-white" name="description" id="description" required style="height:150px;"><?php echo $description ?></textarea>
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group row">
                          <label for="col-sm-3 col-form-label"><?php echo lang("Solution");?></label>
                          <textarea class="form-control m-3 text-white" name="solution" id="solution" required style="height:150px;"><?php echo $solution ?></textarea>
                        </div>
                      </div>
            ...
            if (isset($_POST['submit'])){
              ...
              $sentencia = "UPDATE `vulnerabilities` SET `name`='$name',`description`='$description',`solution`='$solution',";
              $sentencia .= " `level`='$level' WHERE id=".$id_url.";";
