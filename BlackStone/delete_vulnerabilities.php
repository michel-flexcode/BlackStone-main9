            ...
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <?php
                      $sentencia = "DELETE FROM `vulnerabilities` WHERE id=".$id_url;    
                    ...
                    <a class="nav-link btn btn-info col-lg-1 col-12 create-new-button" aria-expanded="false" href="vulnerabilities.php"><?php echo lang("Return");?></a>
                  </div>
                </div>
              </div>
            </div>
