...
<html>
  <head>
    ...
    <title>blackstone9 - <?php echo lang("Scope");?></title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="edit_report.php?id=<?php echo $id_url ?>"><?php echo lang("Report");?></a></li>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                        $sentencia = "select * from scope where id_report=".$id_url." order by ordre";    
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="'.$ordre_scope.'" name="ordre" style="color:white">
                                            </div>
                                        </div>
                    ...
                    ?>
                        <a class="btn btn-primary" href="edit_report.php?id=<?php echo $id_url ?>" name="boton" style="padding-top: 10px; margin-top: 35px;"><?php echo lang("Return"); ?></a> 
                    </div>
                </div>
            </div>
        </div>
          ...
          <?php
            ...
            if (isset($_POST['boton'])){
                ...
                $sentencia = "UPDATE `scope` SET `url`='$url', `ordre`='$ordre' WHERE id=".$id;
