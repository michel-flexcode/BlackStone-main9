          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" aria-expanded="false" href="insert_report.php">+ <?php echo lang("Add report");?> </a>
              </li>
                    ...
                    <div class="table-responsive">
                      <table class="table" id="tabla_listado_cve">
                        ...
                        while($file= mysqli_fetch_array($consulta)){
                                ...
                                $consulta_company = mysqli_query($connection, $sentencia_company) or die("Error de conexión en tabla vulnerabilities");
                                ...
                                if($state == "Terminado"){
                                    $state = '<label class="badge badge-success">'.lang('Finalized').'</label>';
                                }else if ($state == "En proceso"){
                                  $state = '<label class="badge badge-warning">'.lang('In process').'</label>';
                                }
                        ?>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a href="edit_report.php?id=<?php echo $id ?>"><i class="mdi mdi-border-color" style="font-size:20px"></i></a></td>
                            <td><a href="eliminar_report.php?id=<?php echo $id ?>"><i class="mdi mdi-close-circle-outline" style="color:red; font-size:20px"></i></a></td>
                          </tr>
                          <?php
                            }
                          ?>
