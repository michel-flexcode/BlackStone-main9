    ...
    ?>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <?php 
            $sentencia = "select * from scope_vulnerabilities where id=".$id_url;    
          ...
          ?>
            ...
            <?php
                ...
                while($file_fotos = mysqli_fetch_array($consulta_fotos)){
                    ...
                    $url_imagen=$file_fotos['conclusion'];
                    $description_imagen=$file_fotos['description'];
                }
            ?>    
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="form-group row">
                          ...
                          <textarea class="form-control m-3 text-white" name="description" id="description" required style="height:150px;"><?php echo $description_imagen; ?></textarea>
                        </div>
                      </div>
            ...
            <?php
              if (isset($_POST['submit'])){
                ...
                $sentencia = "UPDATE `pocs` SET `description`='$description'";
