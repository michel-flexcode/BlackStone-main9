          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" aria-expanded="false" href="insert_vulnerabilities.php">+ <?php echo lang("Add vulnerability");?> </a>
              </li>
                    ...
                    <div class="table-responsive">
                      <table class="table" id="tabla_listado_cve">
                        ...
                        <?php
                          ...
                          $sentencia = "select * from vulnerabilities order by id";    
                          $consulta = mysqli_query($connection, $sentencia) or die("Error de conexión en tabla vulnerabilities");
                            ...
                            while($file= mysqli_fetch_array($consulta)){
                                $id=$file['id'];
                                $name=$file['name'];
                                $description=htmlspecialchars($file['description'], ENT_QUOTES | ENT_HTML5, 'UTF-8');
                                $level=$file['level'];
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a href="edit_vulnerabilities.php?id=<?php echo $id ?>"><i class="mdi mdi-border-color" style="font-size:20px"></i></a></td>
                            <td><a href="delete_vulnerabilities.php?id=<?php echo $id ?>"><i class="mdi mdi-close-circle-outline" style="color:red; font-size:20px"></i></a></td>
                          </tr>
                          <?php
                            }
                          ?>
