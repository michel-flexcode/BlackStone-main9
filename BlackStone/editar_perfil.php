...
<html>
  <head>
    ...
    <title>blackstone9 - <?php echo lang("Profile");?></title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="vulnerabilities.php"><?php echo lang("Profile");?></a></li>
            ...
            if (isset($_POST['submit'])){
              ...
              $sentencia = "UPDATE `users` SET `pass`='$contra_hash' WHERE id=1";
