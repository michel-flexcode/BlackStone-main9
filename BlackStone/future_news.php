...
<html>
  <head>
    ...
    <title>blackstone9 - <?php echo lang("Companies");?></title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="page-header">
              <h3 class="page-title"> <?php echo lang("Seguimos mejorando blackstone9"); ?> </h3>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul>
                      <li>Instalador propio y automatizado para despliegue de blackstone9 en Kali Linux</li>
                      <li>Reemplazar resultados de Hunter.io por resultados similaes nativos en la app.</li>
                      <li>solutionados numerosos campos sensibles a XSS almacenado.</li>
                      <li>Limitación de acceso a la app blackstone9 únicamente al equipo que la ejecuta (nadie en tu red que detecte tu puerto 80 levantado podrá acceder a esta app).</li>
                      ...
                      <li>Búsqueda de subdominios automática en la ficha de cliente, dicha funcionalidad es nativa del propio código de blackstone9).</li>
                      <li>solutionadas diversas traducciones español/inglés.</li>
                      <li>Integración de icono del sistema para blackstone9, se añade la aplicación en Kali como una aplicación nativa con su propio lancuher.</li>
                      <li>Rediseño de report técnico.</li>
                      <li>Implantación de un nuevo report ejecutivo.</li>
                      <li>Ahora se pueden añadir descriptions a las imágenes de las evidencias.</li>
