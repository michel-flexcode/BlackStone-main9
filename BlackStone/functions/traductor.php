...
function lang($sentencia){
    ...
    if($sentencia == "Conclusions" && $_SESSION['idioma'] == "ES"){ $sentencia = "conclusions";};
    ...
    if($sentencia == "or maintained by other providers. blackstone9 bases these recommendations on of your previous experience with the capabilities of these products. However, blackstone9 cannot and should not guarantee that any particular product will perform as advertised by the seller." && $_SESSION['idioma'] == "ES"){ $sentencia = "o mantenidas por otros proveedores. blackstone9  basa estas recomendaciones a partir de su experiencia previa con las capacidades de estos productos. Sin embargo, blackstone9 no puede y no debe garantizar que un determinado producto funcionará según lo anunciado por el vendedor. ";};
