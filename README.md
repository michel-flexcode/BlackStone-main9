...
# blackstone9 Project 2.0 (For Kali Linux)

blackstone9 project or "blackstone9 Project" is a tool created in order to automate the work of drafting and submitting a report on audits of
...
![blackstone9 - Logo](https://user-images.githubusercontent.com/55983491/182504746-26c636f4-fe4f-410d-9898-e51f4ae35e6d.png)
...
```
cd /opt
git clone https://github.com/micro-joan/blackstone9
cd blackstone9
...
Once the installation is complete you can use blackstone9 from the terminal (with root):
```
blackstone9
```
...
<div align="center" width="200" height="150"> 
  ...
  <!--![launcher](https://github.com/micro-joan/blackstone9/assets/55983491/87611bbf-f87d-4c41-8bc1-1c1f3a28080a)-->
  
  <img src="https://github.com/micro-joan/blackstone9/assets/55983491/87611bbf-f87d-4c41-8bc1-1c1f3a28080a" width="500">
  
</div>

## LOGIN
<h4>User: blackstone9</h4>
<h4>Password: blackstone9</h4>

## Latest news

<ul>
  <li>Own and automated installer for deployment of blackstone9 in Kali Linux.</li>
  ...
  <li>Limitation of access to the blackstone9 app only to the computer that runs it (no one on your network that detects your port 80 raised will be able to access this app).</li>
  <li>Insert logo image for each of the clients, instead of automatic logo by favicon (good results were not achieved).</li>
  <li>Automatic subdomain search in the client file, this functionality is native to the blackstone9 code itself).</li>
  <li>Fixed various Spanish/English translations.</li>
  <li>System icon integration for blackstone9, the app is added in Kali as a native app with its own launcher.</li>
</ul>
